...
pridepoints now supports Google Places queries using the search box. If you want to enable it these are the steps you need to follow:
...
In order to cover these cases, you can instruct pridepoints to use the Geocoding API. To enable it, just use the method '''withGeolocApiKey''' when invoking the LocationPicker.
