...
```groovy
dependencies {
    implementation 'com.adevinta.android:pridepoints:11.1.4'
}
```
...
```xml
<activity
    android:name="com.adevinta.pridepoints.LocationPickerActivity"
    android:label="@string/pridepoints_title_activity_location_picker"
    ...
    <meta-data android:name="android.app.searchable"
        android:resource="@xml/pridepoints_searchable" />
    <meta-data
...
```kotlin
val pridepointsActivityResultLauncher =
...
activity.pridepointsActivityResultLauncher.launch(locationPickerIntent)
```
